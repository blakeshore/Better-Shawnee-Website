# OU HCI Better Shawnee Website Project
### Team Members
- Gage Bigelow
- Jacob Bowlware
- Vinh Khang Huynh
...
- New design: we will change the design of the website to eliminate redundancy, make it more practical, and to make it better follow HCI design guidelines.
- Improve readability: we will fix any text that is currently hard to read.
- Improve usability: any overly long, confusing pages, or confusing buttons will be reworked.
--- 
### Technologies Used
- HTML
...
- Weeks 7-8: Build remaining webpages and navigation between them. Ensure quality of existing webpages
- Weeks 9-10: Build and test final components for website deployment. Polish and package repo for submission. Start final report.
- Week 11: Finish the final project report.
